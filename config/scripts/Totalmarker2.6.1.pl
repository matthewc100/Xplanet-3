...
my $xplanet_dir = $ENV{'XPLANET_DIR'} || "C:\\Users\\mcoblent\\xplanet-1.3.0\\xplanet";
...
my $iss_file = "$xplanet_satellites_dir\\iss";

#where the iss.tle will be written to
my $isstle_file = "$xplanet_satellites_dir\\iss.tle";

#where the label file will be written to
